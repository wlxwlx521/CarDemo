...
public class MyMessageStatusFormatter implements IMessageStatusIconFormatter, IMessageStatusTextFormatter {
    ...
    public MyMessageStatusFormatter(Context context) {
        //Init icons
        mDeliveringIcon = DrawableCompat.wrap(ContextCompat.getDrawable(context, R.mipmap.ic_mail_outline));
        mDeliveredIcon = DrawableCompat.wrap(ContextCompat.getDrawable(context, R.mipmap.ic_done));
        mSeenIcon = DrawableCompat.wrap(ContextCompat.getDrawable(context, R.mipmap.ic_done_all));
        mErrorIcon = DrawableCompat.wrap(ContextCompat.getDrawable(context, R.mipmap.ic_report));
        //Set colors
